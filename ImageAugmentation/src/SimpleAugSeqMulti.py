...
def augment(self, path: str, save_path: str, seed: int, num_copies: int , name: str):
    ...
    #with Halo(text=f"Augmenting \"{title}.jpg/xml\"", spinner='dots'):
    ...
    #print_green(f"Saved {self.num_copies} augmented versions of {self.name} as {self.name}_aug_<copy #>.jpg/xml")
    #print("---------------------------------")
